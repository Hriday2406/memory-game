export default function Card({ item, level, onClick }) {
  ...
  return (
    <div
      className={`transition-all duration-200 p-3 border-2 rounded-3xl flex flex-col items-center gap-3 hover:scale-105 uppercase hover:shadow-lg group backdrop-blur-sm active:scale-90
